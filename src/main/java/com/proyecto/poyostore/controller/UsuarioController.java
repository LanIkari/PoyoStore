...
public class UsuarioController {
    ...
    public ResponseEntity<?> createNewUsuario(@RequestBody Usuario usuario) {
        try {
    ...
    public ResponseEntity<?> getUsuarioById(@PathVariable String id) {
        try {
            return new ResponseEntity<Usuario>(UsuarioService.getUsuarioById(id).get(), HttpStatus.OK);
        } catch (Exception e) {
